...
import type { AppControllerGetHelloData, AppControllerGetHelloResponses, AppControllerTestUserData, AppControllerTestUserResponses, CoursesControllerCreateData, CoursesControllerCreateResponses, CoursesControllerDeleteData, CoursesControllerDeleteResponses, CoursesControllerFindAllData, CoursesControllerFindAllResponses, CoursesControllerFindOneData, CoursesControllerFindOneResponses, CoursesControllerUpdateData, CoursesControllerUpdateResponses } from './types.gen';
...
export const appControllerTestUser = <ThrowOnError extends boolean = false>(options?: Options<AppControllerTestUserData, ThrowOnError>) => {
    return (options?.client ?? client).get<AppControllerTestUserResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const coursesControllerFindAll = <ThrowOnError extends boolean = false>(options?: Options<CoursesControllerFindAllData, ThrowOnError>) => {
    return (options?.client ?? client).get<CoursesControllerFindAllResponses, unknown, ThrowOnError>({
        url: '/courses',
        ...options
    });
};
...
export const coursesControllerCreate = <ThrowOnError extends boolean = false>(options: Options<CoursesControllerCreateData, ThrowOnError>) => {
    return (options.client ?? client).post<CoursesControllerCreateResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const coursesControllerDelete = <ThrowOnError extends boolean = false>(options: Options<CoursesControllerDeleteData, ThrowOnError>) => {
    return (options.client ?? client).delete<CoursesControllerDeleteResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const coursesControllerFindOne = <ThrowOnError extends boolean = false>(options: Options<CoursesControllerFindOneData, ThrowOnError>) => {
    return (options.client ?? client).get<CoursesControllerFindOneResponses, unknown, ThrowOnError>({
        url: '/courses/{id}',
        ...options
    });
};
...
export const coursesControllerUpdate = <ThrowOnError extends boolean = false>(options: Options<CoursesControllerUpdateData, ThrowOnError>) => {
    return (options.client ?? client).patch<CoursesControllerUpdateResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
