...
const sidebarItems = [
  ...
  { label: "미션 관리", href: "/instructor#" },
  { label: "멘토링 관리", href: "/instructor#" },
  { label: "강의 질문 관리", href: "/instructor#" },
  { label: "수강평 리스트", href: "/instructor#" },
  { label: "새소식 관리", href: "/instructor#" },
  { label: "수익 확인", href: "/instructor#" },
  { label: "쿠폰 관리", href: "/instructor#" },
];
