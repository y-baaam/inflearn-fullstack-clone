...
export class LecturesController {
  ...
  @ApiOkResponse({ description: '새 강의 생성 성공', type: LectureEntity })
  create(
  ...
  @ApiOkResponse({ description: '개별 강의 상세 정보', type: LectureEntity })
  ...
  @ApiParam({ name: 'lectureId', description: '개별 강의 ID' })
  @ApiOkResponse({ description: '개별 강의 삭제 성공', type: LectureEntity })
